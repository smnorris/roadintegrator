-- -----------------------
-- name: abr!
-- Process and load active as-built roads, snapping to existing roads
-- -----------------------
...
(
  ...
  WHERE a.road_section_line_id != b.road_section_line_id
