...
SELECT
  ...
  i.og_petrlm_dev_rd_pre06_pub_id AS og_dev_pre06_og_petrlm_dev_rd_pre06_pub_id,
  og_dev_pre06.petrlm_development_road_type AS og_dev_pre06_petrlm_development_road_type,
  og_dev_pre06.application_received_date AS og_dev_pre06_application_received_date,
  og_dev_pre06.proponent AS og_dev_pre06_proponent,
  i.og_road_segment_permit_id AS og_permits_og_road_segment_permit_id,
  og_permits.road_number AS og_permits_road_number,
  og_permits.segment_number AS og_permits_segment_number,
  og_permits.road_type AS og_permits_road_type,
  og_permits.road_type_desc AS og_permits_road_type_desc,
  og_permits.activity_approval_date AS og_permits_activity_approval_date,
  og_permits.proponent AS og_permits_proponent,
